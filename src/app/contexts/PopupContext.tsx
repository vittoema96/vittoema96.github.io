...
import AlertPopup from '@/app/components/popup/AlertPopup.tsx';
import D20Popup, { D20PopupProps } from '@/app/components/popup/dice/D20Popup.tsx';
import D6Popup, { D6PopupProps } from '@/app/components/popup/dice/D6Popup.tsx';
import Nd6Popup, { Nd6PopupProps } from '@/app/components/popup/dice/Nd6Popup.tsx';
import Nd20Popup, { Nd20PopupProps } from '@/app/components/popup/dice/Nd20Popup.tsx';
import AddItemPopup, { AddItemPopupProps } from '@/app/components/popup/AddItemPopup.tsx';
...
export function PopupProvider({ children }: Readonly<React.PropsWithChildren>) {
    ...
    const showToast: PopupContextValue["showToast"] = useCallback((content, variant: ToastVariant = 'danger') => {
        setToastState({ message: content, variant });
    }, []);
